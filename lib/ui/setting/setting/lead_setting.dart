...
class LeadSetting extends StatefulWidget {
  const LeadSetting({Key? key}) : super(key: key);

  @override
  State<LeadSetting> createState() => _LeadSettinState();
}

class _LeadSettinState extends State<LeadSetting> {
  @override
...
Future<LeadSettingModel> getSearchCall() async {
  ...
  final body = {
    ...
    "Details": {
      "id": 2,
      "default_search": "All Lead",
      "primary_sort": "First Name DESC",
      "secondary_sort": "Email DESC",
      "search_fields": "Full Name, Company, Email, Lead Source",
      "platform_name": ".",
      "display_fields": "Full Name, Email, Lead Source",
      "entity_type": "lead",
      "user_id": 32222,
