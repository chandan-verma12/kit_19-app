...
class _AppointmentDetails extends BaseClass<AppointmentDetails>
  ...
  void gotoEditAppointment(TaskDetails? details) async {
    final result = await Navigator.pushNamed(context, AddAppointment.tag,
        arguments: details);
    if (result != null) {
      if (result as bool) {
