...
class LeadSendVoice extends StatefulWidget {
  const LeadSendVoice({Key? key}) : super(key: key);

  @override
  State<LeadSendVoice> createState() => _LeadSendVoiceState();
}

class _LeadSendVoiceState extends State<LeadSendVoice> {
  bool value = false;
...
class _CustomToggleButtonState extends State<CustomToggleButton> {
  late List<String> isSelected;

  @override
  void initState() {
    isSelected = ['promo', 'trans'];
    super.initState();
  }
