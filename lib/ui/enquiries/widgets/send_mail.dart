              ...
              if (EnquiryDetails.email1 == 'null') ...[
                ...
                Row(
                  children: [
                    ...
                    Text(
                      EnquiryDetails.email1,
                      style: const TextStyle(fontSize: 14),
                    ),
                  ],
                ),
              ],
              if (EnquiryDetails.email2 == 'null') ...[
                const Text(''),
              ] else ...[
                Row(
                  children: [
                    const CheckBoxCustom(),
                    Text(
                      EnquiryDetails.email2,
                      style: const TextStyle(fontSize: 14),
                    ),
                  ],
                ),
              ],
              if (EnquiryDetails.email3 == 'null') ...[
                const Text(''),
              ] else ...[
                Row(
                  children: [
